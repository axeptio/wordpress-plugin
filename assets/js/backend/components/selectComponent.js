export default function SelectComponent() {
    ...
    return {
        ...
        /**
         * Returns the selected option label with flag image.
         * Note: HTML returned is safe as option data comes from trusted server source
         * (language configuration from WordPress admin), not user input.
         */
        getSelectedLabel() {
        ...
        focusNextOption() {
            ...
            if ( this.state.focusedOptionIndex + 1 >= this.state.options.length ) {
                return;
            }
