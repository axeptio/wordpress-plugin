...
use Axeptio\Plugin\Backend\Settings;
...
use Axeptio\Plugin\Frontend\Sdk_Proxy;
...
class Module_Initialization {
	 ...
	 */
	private static ?Module_Initialization $instance = null;
	...
	/**
	 * Get all the Axeptio plugin classes.
	 *
	 * @return array
	 */
	...
	/**
	 * Initialize all the Axeptio plugin classes.
	 *
	 * @return void
	 */
