...
sequenceDiagram
    ...
    LA->>LA: Setup Node 24 + Corepack (Yarn 4) + yarn install --immutable
    LA->>LA: yarn eslint
    LA->>LA: Setup PHP 7.4 + composer install --no-interaction
    LA->>LA: composer phpcs
    LA->>LA: composer test
    LA->>DJ: lint-and-test passed (needs:)
    DJ->>DJ: Setup Node 24 + Corepack + yarn install --immutable
...
| Setup Node.js                 | `actions/setup-node@v4` — Node 24                 | Matches local Volta pin                                       |
...
| Setup PHP                     | `shivammathur/setup-php@2.37.2` — PHP 7.4         |                                                               |
...
| :---------------------------- | :------------------------------------------------ | :------------------------------------------------------------------------------- |
| Checkout code                 | `actions/checkout@v4`                             |                                                                                  |
| Setup Node.js                 | `actions/setup-node@v4` — Node 24                 |                                                                                  |
