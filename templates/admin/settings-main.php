			...
			<div class="px-6 py-4 lg:pb-0">
				<div class="mt-6 mb-0 md:flex md:justify-between">
					...
					<div class="inline-flex items-center">
						...
						<a href="https://support.axeptio.eu/en/articles/274018-wordpress-integration" target="_blank" class="text-sm font-semibold"><?php esc_html_e( 'Documentation', 'axeptio-wordpress-plugin' ); ?></a>
					</div>
				</div>
				<div>
					<?php settings_errors(); ?>
