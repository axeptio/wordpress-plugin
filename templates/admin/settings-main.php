			...
			<div class="px-6 py-4 lg:pb-0">
				<div class="mt-6 mb-0 md:flex md:justify-between">
					<div class="md:inline-flex md:items-end">
						...
						<div class="mt-2 lg:mt-0 md:ml-6 text-base mb-1"><?php esc_html_e( 'Your Axeptio Settings', 'axeptio-sdk-integration' ); ?></div>
					</div>
					...
					<div class="inline-flex items-center">
						...
						<a href="https://support.axeptio.eu/en/articles/274018-wordpress-integration" target="_blank" class="text-sm font-semibold"><?php esc_html_e( 'Documentation', 'axeptio-sdk-integration' ); ?></a>
					</div>
				</div>
				<div>
					<?php settings_errors(); ?>
