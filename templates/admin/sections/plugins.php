						...
						<div>
							<div class="min-w-0 flex items-start gap-x-3 flex-auto">
								...
								>
									...
									<div class="ml-1"><?php esc_attr_e( 'This extension is subject to consent', 'axeptio-sdk-integration' ); ?></div>
								</div>
								...
								>
									...
									<div class="ml-1"><?php esc_attr_e( 'This extension is managed through WP Consent API', 'axeptio-sdk-integration' ); ?></div>
								</div>
								<?php endif; ?>
							</div>
