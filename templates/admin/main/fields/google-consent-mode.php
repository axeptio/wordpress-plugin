	...
	<div class="flex">
		...
		<div class="ml-3">
			<p class="text-sm text-yellow-700">
				<?php esc_html_e( 'Google Consent Mode requires the WP Consent API plugin to be active.', 'axeptio-sdk-integration' ); ?>
...
$axeptio_google_params_list    = array(
	array(
		'label'       => esc_html__( 'Analytics storage', 'axeptio-sdk-integration' ),
		'description' => esc_html__( 'Allow Google Analytics to measure how visitors use the site to enhance functionality and service.', 'axeptio-sdk-integration' ),
		'name'        => 'analytics_storage',
	),
	array(
		'label'       => esc_html__( 'Ad Storage', 'axeptio-sdk-integration' ),
		'description' => esc_html__( "Permit Google to save advertising information on visitors' devices for better ad relevance.", 'axeptio-sdk-integration' ),
		'name'        => 'ad_storage',
	),
	array(
		'label'       => esc_html__( 'Ad User Data', 'axeptio-sdk-integration' ),
		'description' => esc_html__( "Share visitors' activity data with Google for targeted advertising.", 'axeptio-sdk-integration' ),
		'name'        => 'ad_user_data',
	),
	array(
		'label'       => esc_html__( 'Ad Personalization', 'axeptio-sdk-integration' ),
		'description' => esc_html__( 'Customize the ad experience by allowing Google to personalize the ads that visitors see.', 'axeptio-sdk-integration' ),
		'name'        => 'ad_personalization',
	),
	array(
		'label'       => esc_html__( 'Functionality storage', 'axeptio-sdk-integration' ),
		'description' => esc_html__( 'Enables storage that supports the functionality of the website or app, for example, language settings.', 'axeptio-sdk-integration' ),
		'name'        => 'functionality_storage',
	),
	array(
		'label'       => esc_html__( 'Personalization storage', 'axeptio-sdk-integration' ),
		'description' => esc_html__( 'Enables storage related to personalization, for example, video recommendations.', 'axeptio-sdk-integration' ),
		'name'        => 'personalization_storage',
	),
	array(
		'label'       => esc_html__( 'Security storage', 'axeptio-sdk-integration' ),
		'description' => esc_html__( 'Enables storage related to security such as authentication functionality, fraud prevention, and other user protection.', 'axeptio-sdk-integration' ),
...
<div class="mt-2 text-sm text-gray-900" x-show="activeGoogleConsentMode" <?php echo ! \Axeptio\Plugin\Models\WP_Consent_API_Settings::is_active() ? 'class="opacity-50 pointer-events-none"' : ''; ?>>
	<div class="font-medium mt-3 mb-1"><?php echo esc_html__( 'Default settings for consent mode', 'axeptio-sdk-integration' ); ?></div>
	<div class="text-gray-500 text-xs mb-4">
		<?php echo esc_html__( 'These consent signals will be sent at page load to tell Google services how they should handle data before consent is granted or denied.', 'axeptio-sdk-integration' ); ?>
	</div>
