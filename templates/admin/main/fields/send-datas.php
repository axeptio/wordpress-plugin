...
<div class="inline-flex items-center w-full relative">
	...
	<input type="checkbox" @change="sendDatas = !sendDatas" class="sr-only" id="xpwp_disable_send_datas" name="axeptio_settings[disable_send_datas]" value="1" <?php echo (bool) \Axeptio\Plugin\get_option( 'disable_send_datas', '0' ) ? 'checked' : ''; ?> placeholder="">
</div>
